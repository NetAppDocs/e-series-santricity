...
* You can also launch the Consolidate Free Capacity dialog box from the Pools and volume groups page as described in the following task.
...
. Click the menu:ellipsis icon[Consolidate volume group free capacity].
+
...
Select menu:Storage[Operations in Progress] to view the progress of the Consolidate Free Capacity operation. This operation can be lengthy and could affect system performance.
