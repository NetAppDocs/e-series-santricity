...
. Click the menu:ellipsis icon[Change volume ownership].
+
The Change Volume Ownership window appears. All volumes on the storage array appear in this dialog box.
