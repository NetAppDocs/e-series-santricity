...
. Select the host cluster you want to edit, and then click the menu:ellipsis icon[Edit Settings].
+
A window appears that shows the current host cluster settings.
