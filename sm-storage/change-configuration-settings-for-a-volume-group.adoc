...
. Select the volume group that you want to edit, and then click the menu:ellipsis icon[Edit Settings].
+
The Edit Volume Group Settings window appears.

. Edit the volume group settings as appropriate.
+
.Field details
[%collapsible]
====
