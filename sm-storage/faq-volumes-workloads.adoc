...
* You can also menu:Storage[Pools and volume groups] from the left panel and then select the menu:ellipsis icon[Consolidate volume group free capacity] to launch the dialog box.
