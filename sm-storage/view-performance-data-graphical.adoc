...
* *Applications and workloads View* -- Displays a list of logical objects (volumes) grouped by the application types and workloads you have defined.
...
. Select *Logical View* tab, *Physical View* tab, or *Applications and workloads View* tab.
+
...
a|
Applications and workloads View
a|
 ** *Storage array*: IOPS, MiB/s
