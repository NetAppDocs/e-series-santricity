...
. Click the menu:ellipsis icon[Change volume media scan settings].
+
The Change Drive Media Scan Settings window appears. All volumes on the storage array appear in this dialog box.

. To enable the media scan, select the *Media scan* check box.
+
