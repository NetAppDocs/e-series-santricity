...
. Select the snapshot volume that you want to edit, and then click the menu:ellipsis icon[Edit Settings].
+
The Edit Snapshot Volume Reserved Capacity Settings window appears.
