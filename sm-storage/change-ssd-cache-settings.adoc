...
summary: "You can edit the settings of the SSD Cache. Current settings for the SSD cache are accessible through the View settings option."
---
...
[.lead]
You can edit the settings of the SSD Cache. Current settings for the SSD cache are accessible through the View settings option.

.Steps

. From the left panel, select menu:Storage[Pools and volume groups].
. Select the SSD Cache that you want to edit, and then click the menu:ellipsis icon[Edit Settings].
+
