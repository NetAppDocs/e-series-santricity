...
+
You Add capacity to a volume by selecting menu:Storage[Volumes] from the left panel and then selecting the menu:ellipsis icon[Increase capacity] for the volume.
...
When you copy volumes, you create a point-in-time copy of two separate volumes, the source volume and the target volume, on the same storage array. You can copy volumes by selecting menu:Storage[Volumes] and then selecting the menu:ellipsis icon[Copy volume].
...
You can initialize volumes by selecting menu:Storage[Volumes > ellipsis icon > Initialize volumes].
...
You can redistribute volumes by selecting menu:Storage[Volumes > ellipsis icon > Redistribute volumes].

== Change volume ownership

Changing the ownership of a volume changes the preferred controller ownership of the volume. The preferred controller owner of a volume is listed under menu:Storage[Volumes > ellipsis icon > Edit settings].

You can change the ownership of a volume by selecting menu:Storage[Volumes > ellipsis icon > Change volume ownership].
...
Select menu:Storage[Volumes > ellipsis icon > Change cache settings] to change the following cache settings:
