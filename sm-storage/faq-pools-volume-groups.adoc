...
You can change the preservation capacity from *Pools and volume groups*. Select the pool that you want to edit. Click *View/Edit Settings*, and then select the *Settings* tab.
...
Resource Provisioning is a feature available in the EF80, EF50,  EF300/EF300C, and EF600/EF600C storage arrays, which allows volumes to be put in use immediately with no background initialization process.
