...
. From the left panel, select menu:Storage[Snapshots].
. Click the *Snapshots Schedules* tab.
. Select the snapshot schedule that you want to delete, click *Delete*, and confirm the operation.
