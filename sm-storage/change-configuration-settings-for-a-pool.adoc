...
. Select the pool that you want to edit, and then click the menu:ellipsis icon[Edit Settings].
+
The Edit pool Setting window appears.

. Edit the pool settings as appropriate.
+
.Field details
[%collapsible]
====
