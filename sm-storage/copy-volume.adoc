...
. Select the volume that you want to use as the source for the Copy Volume operation, and then click the menu:ellipsis icon[Copy volume].
+
The Copy Volume window appears.
...
Select menu:Storage[Operations in Progress] to view the progress of the Copy Volume operation. This operation can be lengthy and could affect system performance.
