...
---
= Add volumes to a workload in SANtricity System Manager
:experimental:
:icons: font
:imagesdir: ../media/
...
. Select the menu:ellipsis icon[Add volumes to workload].
+
...
. When you are satisfied with your workload configuration, click *Add*.
