...
* When unassigned capacity is detected, the Pool Auto-Configuration recommendation appears in the Notifications area (bell icon at the top of the window). Click *View Pool Auto-Configuration* to launch the dialog box.
...
. Click the menu:ellipsis icon[Launch pool auto-configuration].
+
...
. To view additional characteristics of the pool, click the displayed pool name.
+
