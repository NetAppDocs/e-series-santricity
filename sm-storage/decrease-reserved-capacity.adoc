...
. Select the storage object for which you want to decrease reserved capacity, and then click the menu:ellipsis icon[Decrease Capacity].
+
The Decrease Reserved Capacity page appears.
