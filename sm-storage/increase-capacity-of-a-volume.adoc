...
. Select the volume for which you want to increase capacity, and then click the menu:ellipsis icon[Increase Capacity].
+
The Confirm Increase Capacity page appears.

. Select *Yes* to continue.
+
The Increase Reported Capacity page appears.
+
This page displays the volume's current reported capacity and the free capacity available in the volume's associated pool or volume group.
...
* Select menu:Storage[Operations in Progress] to view the progress of the increase capacity operation that is currently running for the selected volume. This operation can be lengthy and could affect system performance.
