...
The dashboard view comprises three summary areas that contain key information about the state and health of your storage array. You can find more information from the summary area.
...
== Notifications area
The Notifications area is available through the bell icon in the upper corner of the window. The Notifications area displays problem notifications that indicate the status of the storage array and its components. In addition, this section displays automated alerts that can help you troubleshoot issues before it affects other areas of your storage environment.

== Interface settings
You can change display preferences and other settings from the main interface.

== User logins and passwords
The current user logged into the system is shown in the user settings.
