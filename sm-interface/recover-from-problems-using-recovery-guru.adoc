...
. From the left panel, select *Home*.
. Click the *Bell* icon and then click the link labeled *Recover from _n_ problems* in the center-top of the window.
+
...
+
The file is saved in the Downloads folder for your browser with the name `recoveryGuru-failureName-arrayName-yyyy-mm-dd-hh-mm-ss.html`.
