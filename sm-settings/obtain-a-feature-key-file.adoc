...
. In System Manager, locate and record the chassis serial number. From the left panel, go to menu:Support[Suport Center] and scroll down to *View top storage array properties* to view the chassis serial number.
. In System Manager, locate the Feature Enable Identifier. From the left panel, go to menu:Settings[System], and then scroll down to *Add-ons*. Look for the *Feature Enable Identifier*. Record the number for the Feature Enable Identifier.
