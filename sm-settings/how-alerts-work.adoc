...
You can configure alerts from the Initial Setup wizard (for email alerts only) or from the Alerts page. To access the Alerts page, go to menu:Settings[Alerts] from the left panel.
