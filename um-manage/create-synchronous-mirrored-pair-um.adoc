...
[NOTE]
====
This feature is not available on the EF80, EF50, EF600/EF600C, or EF300/EF300C storage system.
====
...
Go to System Manager and menu:Storage[Operations in Progress] to view the progress of the synchronous mirroring operation. This operation can be lengthy and could affect system performance.
