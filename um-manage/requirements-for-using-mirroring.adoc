...
[NOTE]
====
Synchronous mirroring is not available on the EF80, EF50, EF600/EF600C, or EF300/EF300C storage array.
====
...
+
NOTE: E4000 controllers do not support iSCSI mirroring.
 ...
 * Primary and secondary volumes must not have Resource Partitioning enabled.
