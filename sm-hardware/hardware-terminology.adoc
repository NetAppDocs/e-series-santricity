...
DULBE
a|
Deallocated or Unwritten Logical Block Error (DULBE) is an option on NVMe drives that allows the EF300/EF300C or EF600/EF600C storage array to support resource-provisioned volumes.
a|
FDE drives
a|
