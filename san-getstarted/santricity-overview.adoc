...
NOTE: EF80, EF50, EF600/EF600C, and EF300/EF300C storage arrays do not support synchronous mirroring or thin volumes.
...
Unified Manager is web-based software used for managing your entire domain. From a central view, you can see the status for all newer E-Series and EF-Series arrays, such as the EF80, EF50, EF80C, EF50C, E4000, E2800, EF280, EF300, E5700, EF570, EF600, EF300C, and EF600C. You can also perform batch operations on selected storage arrays.
