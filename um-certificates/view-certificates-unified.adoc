...
. From the left panel, select menu:Settings[Certificates].
...
. To see more information about a certificate, select its row, select the ellipsis at the end of the row, and then click *View* or *Export*.
