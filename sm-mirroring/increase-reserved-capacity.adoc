...
. Select the storage object for which you want to increase reserved capacity, and then click the menu:ellipsis icon[Increase reserved capacity].
+
The Increase Reserved Capacity page appears.
